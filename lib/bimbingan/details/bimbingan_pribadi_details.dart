...
class Bimbingan_Pribadi_Details extends StatefulWidget {
  const Bimbingan_Pribadi_Details({super.key});

  @override
  State<Bimbingan_Pribadi_Details> createState() => _Bimbingan_Pribadi_DetailsState();
}
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Text("Detail Bimbingan Pribadi",
                            style: TextStyle(
